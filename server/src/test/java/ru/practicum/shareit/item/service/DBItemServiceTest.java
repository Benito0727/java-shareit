...
class DBItemServiceTest {
    ...
    void getItemSet() {
        ...
        assertEquals(2, itemService.getItems(1, 0, 10).size());
    }
    ...
    void getItemsByText() {
        ...
        assertEquals(List.of(expectedItem), itemService.getItemsByText(1, "item", 0, 10));
        assertEquals(List.of(itemDto), itemService.getItemsByText(1, "other", 0, 10));
    }
}